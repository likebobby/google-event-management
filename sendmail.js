...
function sendEmailWithRowData(dataSheet, dataRange, templateRange, subjectRange, appendEventInfo, configSheet) {
  ...
  //Use the first row for rowData, it should be only one row in range
  //The header column = 1 in a Spreadsheet behind a Form
...
function getRowsData(sheet, range, columnHeadersRowIndex) {
  ...
  Logger.log("columnHeadersRowIndex, range.getColumn(), 1 numColumns, " + columnHeadersRowIndex +", "+range.getColumn()+", "+ 1+ ", " +numColumns);
